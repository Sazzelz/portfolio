        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-[1fr_1.5fr] md:gap-x-12 lg:gap-x-20">
          <div>
            <h3 className="text-4xl leading-[1.2] font-bold md:text-5xl lg:text-6xl">
              Exploring Innovative UX/UI Design Projects
            </h3>
          </div>
          <div>
            ...
            <div>
              <div className="flex items-center justify-between gap-8 border-b border-b-border-primary py-5 first:border-t first:border-t-border-primary">
                <h3 className="text-md leading-[1.4] font-bold md:text-lg md:leading-[1.4]">
                  Projects
                </h3>
                <p>Recent Work</p>
              </div>

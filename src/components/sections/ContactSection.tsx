...
export default function ContactSection({ content, label }: ContactSectionProps) {
  return (
    <section
      id="contact"
    ...
    >
      ...
      <p className="mt-4 max-w-2xl text-lg text-neutral-700 sm:text-xl">{content.body}</p>
      <div className="mt-8 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          {content.emailLabel} · hello@anjaliraman.com
        </a>

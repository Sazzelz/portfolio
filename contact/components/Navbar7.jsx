                      ...
                      <div className="grid flex-1 grid-cols-1 content-start items-start gap-x-8 gap-y-6 py-4 md:grid-cols-2 md:py-8 lg:auto-cols-fr lg:grid-cols-4 lg:content-stretch lg:items-stretch lg:gap-y-0">
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Explore my latest design projects and works.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Read insights and updates from my design
                                journey.
                              </p>
                            </div>
                          </a>
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Hear what clients say about my work.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Discover the services I provide for clients.
                              </p>
                            </div>
                          </a>
                        </div>
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Access tools and materials for your projects.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Portfolio Two</h5>
                              <p className="hidden text-sm md:block">
                                Showcasing more of my design expertise.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                In-depth looks at my project processes.
                              </p>
                            </div>
                          </a>
                        </div>
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Client Work</h5>
                              <p className="hidden text-sm md:block">
                                Explore collaborations with various clients.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Join me for design workshops and training.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Stay updated on upcoming design events.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Networking</h5>
                              <p className="hidden text-sm md:block">
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Join Community</h5>
                              <p className="hidden text-sm md:block">
                                Become part of my design community.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Subscribe Now</h5>
                              <p className="hidden text-sm md:block">
